...
function AnimePoster({ data }) {
    return (
        <div className={cx("container", "col-12 h-100")}>
            <Link to={config.routes.anime.replace(":id", data.id)} state={data}>
            ...
            <div className={cx("poster-info", "col-7 h-100")}>
                ...
                <p className={cx("studio")}>
                    <span>Studio: </span>
                    <span className={cx("studio-name")}>Tokyo Animation</span>
                </p>
